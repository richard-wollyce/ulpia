...
**Search for:** `skeleton`, `agente skeleton`, `funcao do skeleton`, `role of skeleton`, `operating instructions`, `instrucoes de operacao`, `constituicao`, `constitution`, `ordem de leitura`, `reading order`, `limites`, `limits`, `limite declarado`, `declared limit`, `escopo`, `scope`, `papel`, `role`, `competencia`, `capability`
